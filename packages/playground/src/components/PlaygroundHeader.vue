...
<template>
  <div class="flex flex-none flex-wrap items-center justify-between gap-2 rounded-t border px-3 py-1.5 text-xs border-pg-border bg-pg-surface-card text-pg-text-soft">
