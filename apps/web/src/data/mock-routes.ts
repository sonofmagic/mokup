...
const coreRoutes: RouteSpec[] = [
  ...
  },
  {
    ...
    description: 'File suffix is GET, rule.method overrides to PATCH.',
...
const extraRoutes: RouteSpec[] = [
  {
    ...
    source: 'mock-extra/url-override.get.ts',
  ...
  },
  {
    ...
    method: 'GET',
    path: '/batch/one',
    source: 'mock-extra/batch.get.ts',
  ...
  },
  {
    ...
    source: 'mock-extra/status.get.ts',
