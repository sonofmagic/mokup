  ...
  '/zh/getting-started/': [
    {
      ...
      items: [
        ...
        { text: 'Node.js 服务直启', link: '/zh/getting-started/quick-start/node-server' },
        { text: 'Node.js 中间件', link: '/zh/getting-started/quick-start/node-middleware' },
      ],
    },
  ],
  '/zh/core-concepts/': [
  ...
  '/getting-started/': [
    {
      ...
      items: [
        ...
        { text: 'Node.js Dev Server', link: '/getting-started/quick-start/node-server' },
        { text: 'Node.js Middleware', link: '/getting-started/quick-start/node-middleware' },
      ],
    },
  ],
  '/core-concepts/': [
