...
- Add `apps/mokup-docs/docs/core-concepts/bundle.md` that covers:
...
- Add `apps/mokup-docs/docs/zh/core-concepts/bundle.md` with a matching structure.
- Update `apps/mokup-docs/docs/.vitepress/config/sidebar.ts` to include the new page.
